...
**Aikaleima:** 20260130_061106

**Query Mode:** `mix`

**Testitapausten määrä:** 18

**Testin kesto:** 0:07:22 (442.4s)
...
|-----------|-------|--------|
| Totuudenmukaisuus | nan | ❌ Heikko |
| Vastauksen relevanssi | nan | ❌ Heikko |
| Kontekstin kattavuus | nan | ❌ Heikko |
| Kontekstin tarkkuus | nan | ❌ Heikko |
| **RAGAS Score (Keskiarvo)** | **nan** | **❌ Heikko** |
